      ...
      child: SingleChildScrollView(
        ...
        child: Obx(() => Row(
          children: List.generate(3, (index) {
            final isActive = controller.controllerStepOne.currentStep.value == index;
            final isCompleted = controller.controllerStepOne.currentStep.value > index;
            final isLast = index == 2;

            return GestureDetector(
              onTap: () {
                if (index <= controller.controllerStepOne.currentStep.value) {
                  controller.controllerStepOne.currentStep.value = index;
                }
              },
