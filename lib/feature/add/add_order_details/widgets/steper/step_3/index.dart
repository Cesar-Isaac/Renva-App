...
class StepReviewOrder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: controller.controllerStepOne.formKeyStep3,
      child: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            SizedBox(height: 5),
            Obx(() {
              final photos = controller.controllerStepTwo.uploadedPhotos;
              if (photos.isEmpty) {
                return Text(
            ...
            const SizedBox(height: 5),
            Text(
              controller.controllerStepOne.description.text,
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w300),
              maxLines: 5,
            ...
            Row(
              children: [
                ...
                SizedBox(width: 10),
                Text(
                  "${controller.controllerStepTwo.priceRange.value.start.toInt()} - ${controller.controllerStepTwo.priceRange.value.end.toInt()} SEK",
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
