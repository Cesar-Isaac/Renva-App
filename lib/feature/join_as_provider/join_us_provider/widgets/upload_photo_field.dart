...
import 'package:renvo_app/feature/join_as_provider/join_us_provider/controller.dart';
...
class UploadPhotoField extends StatelessWidget {
  ...
  const UploadPhotoField({super.key, required this.field});
                  ...
                  photos.isEmpty
                      ? GestureDetector(
                        onTap: () async {
                          ...
                          field.didChange(true); // لإجبار إعادة التحقق
                        },
                        child: Column(
