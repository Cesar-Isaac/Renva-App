...
import 'package:renva/feature/MyOrder/customer/viewOfferCust/OfferDetails/controller.dart';
import 'package:renva/feature/MyOrder/customer/viewOfferCust/model/orderOffers.dart';
import 'package:renva/gen/assets.gen.dart';

import '../../../Rating/widgets/rating_stars.dart';
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    (offer.provider.rate > 0)
                        ? RatingStars(
                      rating: offer.provider.rate.toDouble(),
                    )
                        : SizedBox.shrink(),
                  ],
                ),
