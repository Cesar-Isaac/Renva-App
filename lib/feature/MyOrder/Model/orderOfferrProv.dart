...
class OrderOfferProvModel {
  ...
  factory OrderOfferProvModel.fromRawJson(String str) =>
      OrderOfferProvModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory OrderOfferProvModel.fromJson(Map<String, dynamic> json) =>
      OrderOfferProvModel(
        id: json["id"],
        status: json["status"],
        ...
        prov_offer: json["provider_offer"] != null
