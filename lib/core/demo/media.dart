...
class DemoMedia {
  ...
  static String getRandomImage2(int index) => "https://picsum.photos/id/$index/200/300.jpg";

  static String getRandomImage3(int index) {
    return "https://placehold.co/200x300?text=Story+$index";
  }
  static String getRandomImage4(int index) {
