...
import 'package:renva/feature/MyOrder/customer/viewOfferCust/OfferDetails/index.dart';
import 'package:renva/feature/MyOrder/customer/viewOfferCust/index.dart';
import 'package:renva/feature/MyOrder/index.dart';
import 'package:renva/feature/MyOrder/provider/index.dart';
import 'package:renva/feature/add/add_order_details/index.dart';
import 'package:renva/feature/add/add_order_details/widgets/steper/index.dart';
import 'package:renva/feature/add_offer/index.dart';
import 'package:renva/feature/add_offer/widgets/review_offer.dart';
import 'package:renva/feature/order_details/index.dart';
import 'package:renva/feature/join_as_provider/join_us_provider/index.dart';
import 'package:renva/feature/provider_pages/provider_profile_page/index.dart';
...
import '../../feature/story/index.dart';
...
enum Pages {
  ...
  viewStory => GetPage(name: value, page:()=> StoryViewer())
